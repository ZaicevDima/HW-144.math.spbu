...
class CheckingWin {
     ...
     */
    private static boolean isColumnFill(String[][] valueFromButtons, int indexOfColumn) {
     ...
     * @return true, if filled, else false
     */
    private static boolean isRowFill(String[][] valueFromButtons, int indexRow) {
     ...
     * @return true, if filled, else false
     */
    private static boolean isFirstDiagonalFill(String[][] valueFromButtons) {
     ...
     */
    static boolean isWinner(String[][] valueFromButtons) {
        boolean isWin = false;
        for (int i = 0; i < 3; i++) {
