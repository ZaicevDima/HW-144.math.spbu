...
public class ClassPrinterTest {
    ...
    public void printListClassTest() throws MalformedURLException, ClassNotFoundException {
        ...
        char[] EXPECTED = ("full class name: com.group144.zaicev.List\n" +
                "class name: List\n" +
                "\n" +
                "amount modifiers: 1\n" +
                "is abstract: false\n" +
                ...
                "amount of method parameters: 0\n" +
                "return type: void").toCharArray();
        Arrays.sort(EXPECTED);

        char[] clazzInformation = classInformation(clazz).toCharArray();
        Arrays.sort(clazzInformation);

        Assert.assertArrayEquals(EXPECTED, clazzInformation);
    }
    ...
    public void printStackClassTest() throws MalformedURLException, ClassNotFoundException {
        ...
        char[] EXPECTED = ("full class name: com.group144.zaicev.Stack\n" +
                "class name: Stack\n" +
                "\n" +
                "amount modifiers: 1\n" +
                "is abstract: false\n" +
    ...
    public void printListElementClassTest() throws MalformedURLException, ClassNotFoundException {
        ...
        char[] EXPECTED = ("full class name: com.group144.zaicev.List$ListElement\n" +
    ...
    public void printStackElementClassTest() throws MalformedURLException, ClassNotFoundException {
        ...
        char[] EXPECTED = ("full class name: com.group144.zaicev.Stack$StackElement\n" +
    ...
    public void printIncorrectTreeExeptionClassTest() throws MalformedURLException, ClassNotFoundException {
        ...
        char[] EXPECTED = ("full class name: com.group144.zaicev.IncorrectTreeException\n" +
    ...
    public void printSorterInterfaceClassTest() throws MalformedURLException, ClassNotFoundException {
        ...
        char[] EXPECTED = ("full class name: com.group144.zaicev.Sorter\n" +
                "class name: Sorter\n" +
                "\n" +
